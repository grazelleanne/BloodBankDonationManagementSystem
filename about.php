...
<body>
  ...
  <div class="card">
    <div class="card-body">
      <h4 class="card-title">John Carlo Guligado</h4>
      <p class="card-text">John Carlo is a valuable team member with expertise in frontend, ReactJS, and WordPress. His dedication to growth and continuous learning makes him a valuable asset to any software development project. With a strong foundation in these areas, Noor Ahmed is well-equipped to make valuable contributions to the team..</p>      
	  <div class="row p-2">
	  <ul class="top-right-info">                            
                                <li class="mx-3">
  ...
  <div class="card">
    <div class="card-body">
      <h4 class="card-title">Miko Labadan & Kyziel Dhimcer Lumbab</h4>		
      <p class="card-text">Miko & Kyziel Dhimcer is a valuable team member with expertise in Python and frontend technology. His dedication to growth and continuous learning makes him a valuable asset to any software development project. With a strong foundation in these areas and a passion for staying current, Ritik is well-equipped to make valuable contributions to the team.</p>      
	  <div class="row p-2">
	  <ul class="top-right-info">                            
                                <li class="mx-3">	
